# data_loader.py
# Couche de donnees : chargement des .pkl reels (format yfinance) + generateur
# synthetique pour les tests. Convention : ticker = nom_fichier.split('_')[1].
...
def load_ticker_series(root=config.DATA_DIR, universe=config.UNIVERSE):
    ...
    if not files:
        raise FileNotFoundError(
            f"Aucun .pkl trouve sous '{root}'. Place les donnees du prof dedans."
        )
...
# =========================================================================
#  2) GENERATEUR SYNTHETIQUE (pour developper/tester sans donnees reelles)
# =========================================================================
