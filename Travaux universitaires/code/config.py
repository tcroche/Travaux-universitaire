# config.py
# Paramètres centraux du projet. Tout ce qui se règle une fois vit ici.

# --- Univers d'actifs (noms libres pour le jeu synthétique) ---
TICKERS = ["SPX", "FTSE", "DJI", "N225"]
...
# Fichiers a ignorer (sorties du prof, pas des instruments)
...
# --- Parametres de strategie (valeurs de depart, a calibrer en IS) ---
